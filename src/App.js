      ...
      <Router>
        <div className='App-top-container'>
          <nav className='App-navbar'>
            <Link to='/' className='App-navLink'>
              <div className='App-logo-container'>
                <hr/>
                <p className='App-bodyTime'>BODY SHAPE</p>
                <hr/>
                <p className='App-easyShape'>QUICK RESULT</p>
              </div>
            </Link>
          ...
          <div className='App-navbar'> 
            <div className='App-phone-container'>
              ...
              <p className='App-phoneNumber'>+1.917.345.6731</p>
            </div>

            <div className='App-map-container'>
              <img className='App-mapIcon' src={map} alt='map'/>
              <p className='App-address'>975 Ocean Parkway, #1234, Brooklyn, NY 11230</p>
            </div>
          </div>
        </div>
        ...
        <div className='App-burger-container'>
          ...
          <Link to='/' className='App-navLink'>
              <div className='App-logo-container'>
                <hr/>
                <p className='App-bodyTime burgerLogo'>BODY SHAPE</p>
                <hr/>
                <p className='App-easyShape burgerResult'>QUICK RESULT</p>
              </div>
          </Link>
