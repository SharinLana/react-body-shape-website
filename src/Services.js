                    ...
                    <div className='Services-burger-container'>
                        <div className='Services-burger-innerCont'>
                            ...
                            onMouseLeave={changeBurgerState}>
                                ...
                                onClick={() => filterProcedures('face')}>Face Care</button></li>
                                <li className='Services-burgerLi'><button className='Services-burgerBtn'
                                onClick={() => filterProcedures('body')}>Body Care</button></li>
                                <li className='Services-burgerLi'><button className='Services-burgerBtn'
                                onClick={() => filterProcedures('eyelashes')}>Eyelashes/brows</button></li>
                                <li className='Services-burgerLi'><button className='Services-burgerBtn lastBtn'
                                onClick={() => filterProcedures('hair')}>Hair removal</button></li>
                            </ul>
                            <button 
